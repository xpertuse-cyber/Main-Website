...
export default function Footer() {
  ...
  // Improved function to handle app deep linking with web fallback
  const handleSocialMediaClick = (appUrl, webUrl) => {
    ...
    if (isMobile) {
      ...
      setTimeout(() => {
        ...
        if (!document.hidden && endTime - startTime < 3000) {
          window.open(webUrl, "_blank", "noopener,noreferrer");
        }
      }, 2500);
    } else {
      // Desktop - directly open web URL
      window.open(webUrl, "_blank", "noopener,noreferrer");
    }
  };
  ...
  const navigationLinks = [
    ...
    { name: "Terms and Conditions", action: () => handlePolicyClick('terms') },
              ...
              <div className="flex justify-center gap-3 md:gap-4">
                ...
                <button 
                  onClick={() => handleSocialMediaClick(
                    "linkedin://in/xpert-use-86431938a/",
                    "https://www.linkedin.com/in/xpert-use-86431938a/"
                  )}
                ...
                <button 
                  onClick={() => handleSocialMediaClick(
                    "twitter://user?screen_name=xpertuse",
                    "https://x.com/xpertuse"
                  )}
                ...
                <button 
                  onClick={() => handleSocialMediaClick(
                    "vnd.youtube://channel/UCZfxOIqw1pR76s3cJwQDlCQ",
                    "https://www.youtube.com/channel/UCZfxOIqw1pR76s3cJwQDlCQ"
                  )}
                ...
                <button 
                  onClick={() => handleSocialMediaClick(
                    "instagram://user?username=xpertuse",
                    "https://www.instagram.com/xpertuse/"
                  )}
                ...
                <button 
                  onClick={() => handleSocialMediaClick(
                    "fb://profile/61582082315834",
                    "https://www.facebook.com/profile.php?id=61582082315834"
                  )}
